-- EduPilot AI — Day 1 Foundation Schema (4 tables)
-- + Day 2 Opportunity Discovery tables (3 tables)
-- MySQL 8.x | utf8mb4
...
CREATE TABLE IF NOT EXISTS opportunity_requirements (
    ...
    description       TEXT NOT NULL,
    created_at        TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT fk_oppreq_opp FOREIGN KEY (opportunity_id)
...
CREATE TABLE IF NOT EXISTS saved_opportunities (
    ...
    CONSTRAINT fk_saved_opp FOREIGN KEY (opportunity_id)
        REFERENCES opportunities(id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS applications (
    ...
    user_id          INT NOT NULL,
    opportunity_id   INT NOT NULL,
    status           ENUM('applied','in_review','shortlisted','rejected') NOT NULL DEFAULT 'applied',
...
CREATE TABLE IF NOT EXISTS study_results (
    ...
    created_at      TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT fk_studyres_mat FOREIGN KEY (material_id) REFERENCES study_materials(id) ON DELETE CASCADE,
    CONSTRAINT fk_studyres_user FOREIGN KEY (user_id) REFERENCES users(id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS study_plans (
    ...
    created_at      TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    updated_at      TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    CONSTRAINT fk_studyplan_user FOREIGN KEY (user_id) REFERENCES users(id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS study_tasks (
    ...
    created_at      TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT fk_studytask_plan FOREIGN KEY (plan_id) REFERENCES study_plans(id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS interview_questions (
    ...
    created_at      TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT fk_intq_session FOREIGN KEY (session_id) REFERENCES interview_sessions(id) ON DELETE CASCADE,
